...
/// Legt ein Katalogprodukt und wahlweise eine Slot-Belegung an. Liefert die Produkt-ID.
Future<int> seedProduct(
  ...
  final productId = await database.insert('product', {
    'name': name,
  ...
  if (assignSlot) {
    await database.insert('product_slot', {
