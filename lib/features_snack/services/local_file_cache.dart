...
/// Zwischengespeicherte Datei-Existenzprüfung – vermeidet wiederholtes `existsSync` im Build.
abstract final class LocalFileCache {
  ...
  static bool exists(String? path) {
    ...
    // Positive Treffer zwischenspeichern, negative regelmäßig neu prüfen.
    if (cached == true) {
      return true;
    }
