...
class _ProductOutputState extends State<ProductOutput> with SingleTickerProviderStateMixin {
    ...
    return Card(
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              const Text("Produktausgabe", style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold),),
              const SizedBox(height: 4),
              Expanded(
                child: productName == null
                  ? const Center(
                    child: Text("Leer", style: TextStyle(color: Colors.white38),),
                  )
                  : AnimatedBuilder(
                    animation: _progress,
                    child: Row(
                    ...
                    builder: (context, child) {
                      ...
                      final horizontalMovement = math.sin(progress * math.pi * 4) * (1 - progress) * 18;
